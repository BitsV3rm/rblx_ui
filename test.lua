...
or check_UserId == 18525766 
or check_UserId == 1520110608 
or check_UserId == 1320641791 
or check_UserId == 3225375512 
or check_UserId == 8072344456 
or check_UserId == 3178620698 
or check_UserId == 62243203 
or check_UserId == 191620308 
or check_UserId == 1758245578 
or check_UserId == 1010959344 
or check_UserId == 959680797 
or check_UserId == 2235335089 
or check_UserId == 4272698789 
or check_UserId == 2404227594 
or check_UserId == 1717776 
or check_UserId == 2744991051 
or check_UserId == 14756773 
or check_UserId == 4532949102 
or check_UserId == 1756496937 
or check_UserId == 712803756 
or check_UserId == 8068839418 then	-- Anti-Cheat Disabled
	task.spawn(function()
		...
		for i,v in pairs(workspace.Collect:GetChildren()) do
			if check() and v:FindFirstChild("Part") and v.Part:FindFirstChild("InfoBar") and v.Part.InfoBar:FindFirstChild("DigimonName") and v:FindFirstChild("Health") and v.Health.Value > 0 and not player.PlayerGui.Loading.MainFrame.ImageLabel.Visible then
				...
				if mobNames and string.match(mobNames, parsedName) then
					...
					local digimonName = v.Part.InfoBar.DigimonName.ContentText
					print("Target:", v.Part.InfoBar.DigimonName.ContentText, v.Health.Value)

					repeat 				
						task.spawn(function()
							player.Character.HumanoidRootPart.CFrame = CFrame.new(fixedVector + Vector3.new(0, 3, 0))
							fireclickdetector(v.Check)
						end)
						task.spawn(function()
							if player.PlayerGui.Server.SkillsDisplayDigimon:FindFirstChild("Skill3") then
						...
						task.wait(0.3)
					until game:GetService("Players").LocalPlayer.PlayerGui.Loading.MainFrame.ImageLabel.Visible or not v or not v:FindFirstChild("Health") or v.Health.Value <= 0 or not check()
					warn("Killed:", digimonName)
				end
			end
		end
				...
				if #players > 0 then
					for i, v in ipairs(players) do
						if v.UserId ~= player.UserId then
							repeat task.wait() until not player.PlayerGui.Loading.MainFrame.ImageLabel.Visible
							blockPlayers()
							game:GetService("Players").LocalPlayer:Kick("GUI: Finding an empty server.")
							game:GetService("TeleportService"):Teleport(game.PlaceId)
						end
					end
